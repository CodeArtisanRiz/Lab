    ...
    <body>
        ...
        <section class="container my-5 investigation">
            <form class="" method="POST"  id="formid">
                <div class="row">
                    ...
                    <div class="col">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-label-group">
                                <select class="form-control custom-select" id="ref_doc" name="referredby" required>
                ...
                <div class="row input-form" id="inputf">
                    <div class="col-12">
                        <div class="row form-type">
                            ...
                            <div class="col-6">
                                <div class="form-label-group">
                                    <select class="form-control test_name custom-select" id="1" onchange="putVal(this.value, this.id)" required>
                ...
                <input type="hidden" name="tName" id="tNh">
                <input type="hidden" name="tCode" id="tCh">
                <input type="hidden" name="tPrice" id="tPh">
            </form>
...
error_reporting(0);
    ...
    if(isset($_POST['save'])){
        ...
        $insertquery = "INSERT into patients (pname, age, sex, paddress, mobile, referredBy, tName, tCode, tPrice, total, discount, netTotal, advance, remainingAmt)
        values('$name','$age','$sex','$address','$mobile','$referredby','$testName','$testCode','$testPrice','$total','$disc','$netTotal','$advance','$remainingAmt')";
